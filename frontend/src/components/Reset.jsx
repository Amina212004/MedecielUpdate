...
const Reset = ()=> {
 return (
  ...
  <input
    ...
    className="w-3/4 mb-6 px-5 py-3 rounded-lg text-[#002C4E] text-[18px] font-medium border-[2px] border-[#002C4E] focus:outline-none focus:ring-2 focus:ring-teal-300 h-16 placeholder:text-[20px]"
  />
